...
<head>
  ...
  <title>ROG | Republic of Gamers - LOGIN</title>
</head>
<style>
  body {
    overflow: hidden;
    background-image: url("https://rog.asus.com/dist/img/rog_bg_pattern.jpg");
  }
</style>
    ...
    <div class="px-4 py-5 px-md-5 text-center text-lg-start" style="
      ...
      <div class="container ">
        <div class="row gx-lg-5 align-items-center">
          <div class="col-lg-6 mb-5 mb-lg-0" style="transform: translateX(53vh);">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 40" svg-inline="" src="@images/logo/logo-rog.svg" alt="ROG - Republic of Gamers" role="presentation" focusable="false" style="fill: #ff0029">
              ...
              <div class="col md-4">
                <div class="card p-2 bg-dark text-light">
                  <form action="<?= base_url('main/auth') ?>" method="post">
                    <h1 style="color: #ff0029;">Login</h1>
                    <hr />
                    <?php if (!empty(session()->getFlashdata('fail'))) : ?>
                      <div class="alert alert-danger"><?= session()->getFlashdata('fail'); ?></div>
                    <?php endif; ?>
                    <div class="container-fluid comb-3">
